...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		set_protrait_and_label(character_label.text)
...
func set_protrait_and_label(char_label) -> void:
	# TODO: change based on level if needed
